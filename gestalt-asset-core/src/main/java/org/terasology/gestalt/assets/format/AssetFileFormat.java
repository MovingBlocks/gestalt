...
/**
 * An AssetFileFormat handles loading a file representation of an asset into the appropriate {@link org.terasology.gestalt.assets.AssetData AssetData}.
 *
 * @author Immortius
 */
public interface AssetFileFormat<T extends AssetData> extends FileFormat {
    ...
    /**
     * Creates an {@link org.terasology.gestalt.assets.AssetData AssetData} from one or more files.
     *
