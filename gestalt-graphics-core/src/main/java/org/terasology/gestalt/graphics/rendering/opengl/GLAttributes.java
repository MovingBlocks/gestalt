...
public final class GLAttributes {
    ...
    public static final VertexAttribute<Colorc, Color> COLOR_4_F_VERTEX_ATTRIBUTE = new VertexAttribute<Colorc, Color>(Color.class, new VertexAttribute.AttributeConfiguration<Colorc, Color>() {
        @Override
