...
public class EventReceiverMethodSupportTest {
    ...
    public EventReceiverMethodSupportTest() {
...
//        @Test
//        public void registerEventReceiverMethods() {
//            TestEventReceiver receiver = new TestEventReceiver();
//
//            eventProcessor.register(receiver);
//            TestEvent event = new TestEvent("test");
//            eventProcessor.send(testEntity, event, transaction);
//            assertTrue(receiver.called);
//            assertEquals(TEST_NAME, receiver.component.getName());
//        }
//
//        @Test
//        public void unregisterEventReceiverMethods() {
//            TestEventReceiver receiver = new TestEventReceiver();
//
//            eventProcessor.register(receiver);
//            eventProcessor.unregister(receiver);
//            TestEvent event = new TestEvent("test");
//            eventProcessor.send(testEntity, event, transaction);
