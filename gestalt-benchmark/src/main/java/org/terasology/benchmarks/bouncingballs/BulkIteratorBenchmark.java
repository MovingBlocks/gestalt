...
class BulkIteratorBenchmark implements Benchmark {
    ...
    public String getName() {
        return "Entity Manager iterate Components (double array stores) benchmark";
    }
    ...
    public void setup() {
        ...
        entityManager.addComponentStore(new ArrayComponentStore<>(componentManager.getType(Location.class)));
        entityManager.addComponentStore(new ArrayComponentStore<>(componentManager.getType(Physics.class)));
    ...
    public void doFrame(float delta) {
        Physics physics = new Physics();
        Location location = new Location();
//        entityManager.iterate(physics, location);
