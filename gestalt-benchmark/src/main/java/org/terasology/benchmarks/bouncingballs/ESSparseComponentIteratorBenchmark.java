...
class ESSparseComponentIteratorBenchmark implements Benchmark {
    EntityManager entityManager;
    long bounces;

    @Override
    public String getName() {
        return "Entity Manager Iterator w/ Sparse benchmark";
    }
    ...
    public void setup() {
        ...
        ComponentStore<Location> locationStore = entityManager.addComponentStore(new SparseComponentStore<>(componentManager.getType(Location.class)));
        ComponentStore<Physics> physicsStore = entityManager.addComponentStore(new SparseComponentStore<>(componentManager.getType(Physics.class)));
